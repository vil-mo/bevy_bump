use bevy::math::bounding::{BoundingCircle, BoundingCircleCast};
use bevy::prelude::*;
...
pub trait SolidCollidersAccess: Clone {
    fn bounding_circle_cast(
        &self,
        cast: &BoundingCircleCast,
    ) -> impl Iterator<Item = Aabb>;
}

// use crate::solving::response::{slide, CollisionResponse};
// use bevy::math::bounding::BoundingCircle;
// use bevy::prelude::*;
// use enum_map::{EnumArray, EnumMap};
// use std::marker::PhantomData;
// use std::ops::Deref;
// use crate::solving::SolidColliderAccess;
// 
...
// pub struct ActorBody<L: EnumArray<CollisionResponse<Q>>, Q: SolidColliderAccess, M = ()> {
